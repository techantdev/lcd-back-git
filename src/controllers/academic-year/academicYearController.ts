...
export const createAcademicYear = catchAsync((req: Request) =>
  createAcademicYearMethod(req.body.schoolId, req.body.year, req.body.isCreationBasedOnPreviousYear, req.body.previousAcademicYearId)
);
