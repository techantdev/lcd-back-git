...
export const createTeacherSubjectCourse = catchAsync((req: Request) =>
  createTeacherSubjectCourseMethod(req.body.teacherId, req.body.academicYearId, req.body.yearSubjectId, req.body.courseId)
);
export const deleteTeacherSubjectCourse = catchAsync((req: Request<{}, {}, {}, { teacherSubjectCourseIds: String }>) =>
  deleteTeacherSubjectCourseMethod(req.query.teacherSubjectCourseIds)
);
export const getTeacherSubjectCourse = catchAsync((req: Request<{}, {}, {}, { teacherId: String; academicYearId: String }>) =>
