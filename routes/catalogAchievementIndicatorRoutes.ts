...
router
  ...
  .post(
    catalogAchievementIndicatorController.createCatalogAchievementIndicator
  );

router
  .route("/:catalogAchievementIndicatorId")
  .patch(
    catalogAchievementIndicatorController.updateCatalogAchievementIndicator
  )
  .delete(
    catalogAchievementIndicatorController.deleteCatalogAchievementIndicator
  );
