...
router
  .route("")
  .get(catalogSubjectController.getCatalogSubject)
  .post(catalogSubjectController.createCatalogSubject);
...
router
  .route("/:catalogSubejctId/grades")
  .patch(catalogSubjectController.assignGradeCatalogSubject);
